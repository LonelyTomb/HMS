...
if (Input::getExists('confirm')) {
	$patient->confirmAppointment(Input::catch ('patient'), Sessions::get('user/username'));
}
$paginator = new HMSPaginator($doctor->getAllAppointments(Sessions::get('user/username'), Sessions::get('user/type')), 'appointments', 2);
?>
