...
if (Input::exists()) {
	...
	if ($validator->validate($_POST, $rules)) {
		...
		$doctor = new Doctor();
		$doctor->createDoctor($surname, $otherNames, $gender, $address, $phoneNumber, $email, null);
		$doctor->deletePendingUser($email);
	...
	<div class="panel-body">
		<form action="" method="post" id="form">
			<table class="table datatable-basic table-bordered table-striped table-hover datatable-responsive">
				...
				<tbody>
				<?php foreach ($doctors->getPendingUsers('doctor') as $doctor): ?>
