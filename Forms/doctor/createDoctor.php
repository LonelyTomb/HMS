...
if(Input::exists()){
    ...
    if($validator->validate($_POST,$rules)){
        ...
        $specialization = Functions::escape($_POST['specialization']);
        $doctor = new Doctor($username,$password,$surname,$otherNames,$email,$phoneNumber,$specialization);
        $doctor->createDoctor();
    }else{
...
?>" required>
                    ...
                    <div class="row">
                        <div class="input-field col s12">
                            <input type="text" id="specialization" class="validate" name="specialization" value="<?php echo Input::catch('specialization');
?>" required>
